...
- 앱: 인공지능 수학 순서도 생성기
- 주소: https://ais-dev-aceusjdrkwpqlm2nvpn635-418235644195.asia-east1.run.app 
- 스택: Vite
...
- [v] HTTPS 강제(HTTP→HTTPS 리다이렉트) — HTTP 요청이 HTTPS로 리다이렉트됨 (HTTP 302 -> https://ais-dev-aceusjdrkwpqlm2nvpn635-418235644195.asia-east1.run.app/)
...
- [v] 헤더 설정 위치 — server.ts configures CSP, HSTS, X-Content-Type-Options: nosniff, Referrer-Policy, and Permissions-Policy on all Express responses
- [v] 위험 코드 패턴(검토 후보) — src/components/MermaidViewer.tsx:225
...
- AI에게 이렇게 시켜주세요: `Vite 앱 응답에 Strict-Transport-Security: max-age=63072000; includeSubDomains 헤더를 추가해줘.`
